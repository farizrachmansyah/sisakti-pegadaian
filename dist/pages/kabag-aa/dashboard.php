...
<html lang="en">
  <head>
    ...
    <title>SiSAKTI &MediumSpace;-&MediumSpace; KABAG Anggaran & Akuntansi</title>
    ...
    <main class="main kepala">
      ...
      <div class="header-container">
        <div class="header-container-user flex flex-ai-c flex-jc-sb">
          <span class="name">KABAG Anggaran & Akuntansi</span>
      ...
      <div class="main__content kepala__content">
        ...
        <div class="dropdown show">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            ...
            <a class="dropdown-item" href="../report-realisasi-dept.php" data-linked="realisasi-dept"
            ...
            >
            <a class="dropdown-item" href="../report-total-soa.php" data-linked="total-soa-ma">Total SOA Per Mata Anggaran</a>
          </div>
        </div>
